...
def train_and_save_models():
    ...
    best_heart = train_dataset_models(X_train_h, X_test_h, y_train_h, y_test_h, 'heart')
    ...
    best_diab = train_dataset_models(X_train_d, X_test_d, y_train_d, y_test_d, 'diabetes')
    
    print("\n" + "="*60)
    print("✅ MODULE 2 COMPLETED SUCCESSFULLY!")
    print("="*60)
    print(f"Models saved:")
    print(f"  - modules/module2_ml/model_heart.pkl")
    print(f"  - modules/module2_ml/model_diabetes.pkl")
    print(f"  - modules/module2_ml/results_heart.json")
    print(f"  - modules/module2_ml/results_diabetes.json")
...
def train_dataset_models(X_train, X_test, y_train, y_test, dataset_name):
    ...
    print(f"\n✅ Best model saved with AUC: {best_auc:.4f}")
